...
from bbb.platform import BBBPlatform
from bbb.tx import TX


class Top(Module):
    def __init__(self, platform):
        # Set up clocking. We'll just run at 50MHz to start with.
        self.clk50 = platform.request("clk50")
        self.clock_domains.sys = ClockDomain("sys")
        self.comb += self.sys.clk.eq(self.clk50)
        ...
        self.noise_var = Signal((4, True), reset=1)
